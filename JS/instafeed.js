var userFeed = new Instafeed({
  ...
  template:
    '<div class="instafeed_slider__swiper_slide swiper-slide"><img class="instafeed__image" src="{{image}}"</img><div class="instafeed__caption"><p class="instafeed__text">{{caption}}</p></div></div>',
  accessToken:
